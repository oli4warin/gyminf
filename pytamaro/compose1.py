from pytamaro import compose, pin, show_graphic, save_graphic, rectangle, top_left, top_center, blue, red, top_right, center, bottom_center, bottom_left, bottom_right, center_left
